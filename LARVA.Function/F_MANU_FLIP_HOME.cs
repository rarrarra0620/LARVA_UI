...
{
    public class F_MANU_FLIP_HOME : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oMot_nFlipHome_Req;
        private string reply_io_name = IoNameHelper.iMot_nFlipHome_Reply;

        public F_MANU_FLIP_HOME()
        {
