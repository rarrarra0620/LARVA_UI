...
{
    public class F_MANU_Z_HOME : AbstractFunction
    {
        private string request_io_name = IoNameHelper.oMot_nZHome_Req;
        private string reply_io_name = IoNameHelper.iMot_nZHome_Reply;

        public F_MANU_Z_HOME()
        {
