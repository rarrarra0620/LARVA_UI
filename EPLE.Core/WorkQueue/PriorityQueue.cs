...
namespace BenTools.Data
{
    ...
    {
        #region contructors
        public HighPriorityQueue()
            : base(new ReverseComparer())
        { }

        public HighPriorityQueue(int capacity)
            : base(new ReverseComparer(), capacity)
        { }

        protected HighPriorityQueue(ArrayList Core, IComparer Comp, bool Copy)
            : base(Core, Comp, Copy)
        {
        }
